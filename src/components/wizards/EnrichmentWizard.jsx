...
function EMPanel() {
  return (
    <div className="text-gray-600">
      <picture>
        <source type="image/webp" srcSet="/images/apps/em-web.webp" />
        <img
      ...
      <p className="mt-5">
        Use EnrichmentMap to perform a gene set enrichment analysis and then
        visualize the results as a network.
      </p>
    </div>
  );
}
